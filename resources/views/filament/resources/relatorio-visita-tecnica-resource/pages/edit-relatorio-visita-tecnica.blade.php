<x-filament-panels::page>
    <div
        x-data="visitaTecnicaAutosave($wire)"
        x-init="init()"
        x-cloak
    ...
    <script>
        function visitaTecnicaAutosave($wire) {
            return {
                timer: null,
                dirty: false,
                autosaving: false,
                ...
                createUploadOverlay() {
                    if (document.getElementById('vt-upload-overlay')) {
                        this.uploadOverlayEl = document.getElementById('vt-upload-overlay')
                        return
                    }

                    const wrapper = document.createElement('div')
                    wrapper.id = 'vt-upload-overlay'
                        ...
                        ">
                            <div style="display:flex; gap:16px; align-items:flex-start;">
                                <div style="
                                    ...
                                    flex-shrink:0;
                                ">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="width:24px;height:24px;animation:vt-spin 1s linear infinite;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div style="min-width:0; width:100%;">
                                    ...
                                    <div id="vt-upload-progress-text" style="margin-top:10px; font-size:14px; font-weight:600; color:#111827;">
                    ...
                    if (!document.getElementById('vt-upload-overlay-style')) {
                        const style = document.createElement('style')
                        style.id = 'vt-upload-overlay-style'
                        style.textContent = `
                            @keyframes vt-spin {
                ...
                updateOverlayProgress() {
                    ...
                    const textEl = this.uploadOverlayEl.querySelector('#vt-upload-progress-text')
                    const barEl = this.uploadOverlayEl.querySelector('#vt-upload-progress-bar')
