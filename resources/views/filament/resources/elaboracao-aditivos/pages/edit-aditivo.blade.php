<x-filament-panels::page>
    ...
    >
        <div class="ea-card">
            <div class="ea-head">
                <div>
                    <h1 class="ea-title">EDITAR ADITIVO</h1>
                    <div class="ea-sub">Ajuste os dados da planilha e salve.</div>
                </div>
                <x-filament::button color="warning" wire:click="save">Salvar alterações</x-filament::button>
            </div>
                    ...
                    <tbody>
                        @forelse ($itens as $index => $item)
                            <tr>
                                ...
                                <td style="text-align:center"><button type="button" wire:click="removeLinha({{ $index }})" class="ea-del">Excluir</button></td>
                            </tr>
                        @empty
                            <tr><td colspan="9" style="padding:24px;text-align:center;color:#64748b">Nenhum item informado.</td></tr>
                        @endforelse
                    </tbody>
                </table>
                <div class="ea-foot">
