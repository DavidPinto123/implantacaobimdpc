...
<div>
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Navegação de paginação" class="flex items-center justify-between gap-3">
