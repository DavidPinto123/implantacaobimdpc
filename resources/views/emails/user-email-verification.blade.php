        ...
        <div style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 30px rgba(15,23,42,.08);">
            ...
            <div style="padding:32px;">
                ...
                <p style="margin:0 0 16px; line-height:1.7; font-size:15px;">
                    Precisamos confirmar seu e-mail para liberar seu acesso ao sistema.
                </p>

                <div style="margin:28px 0; text-align:center;">
                    <a href="{{ $verificationUrl }}" style="display:inline-block; padding:12px 22px; border-radius:10px; background:#fbbf24; color:#111827; text-decoration:none; font-weight:700;">
                        Verificar e-mail
                    </a>
                </div>

                <p style="margin:0 0 14px; line-height:1.7; font-size:14px; color:#4b5563;">
                    Depois da verificação, você poderá acessar normalmente o sistema.
                </p>
