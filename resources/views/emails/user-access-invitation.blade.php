...
<head>
    ...
    <title>Seu acesso DPC está pronto</title>
</head>
        ...
        <div style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 30px rgba(15,23,42,.08);">
            ...
            <div style="padding:32px;">
                ...
                <p style="margin:0 0 16px; line-height:1.7; font-size:15px;">
                    Seu acesso ao sistema foi criado. Antes de entrar, conclua a criação do usuário para validar seu e-mail e definir sua senha pessoal.
                </p>

                <div style="margin:28px 0; text-align:center;">
                    <a href="{{ $invitationUrl }}" style="display:inline-block; margin:8px; padding:12px 22px; border-radius:10px; background:#fbbf24; color:#111827; text-decoration:none; font-weight:700;">
                        Concluir criação do usuário
                    </a>
                </div>

                <p style="margin:0 0 14px; line-height:1.7; font-size:14px; color:#4b5563;">
                    Ao clicar, seu e-mail será validado e você será levado diretamente para criar a sua senha.
                </p>
