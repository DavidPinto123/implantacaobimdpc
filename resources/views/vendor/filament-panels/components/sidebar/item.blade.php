...
@php
    ...
    $isCollapsibleParent = $hasChildItems && blank($url);
@endphp

<li
    x-data="{ isOpen: @js($active || $activeChildItems) }"
    {{
        $attributes->class([
            'fi-sidebar-item',
            'fi-active' => $active,
            ...
            {{
                \Filament\Support\generate_icon_html(
                    ...
                    attributes: (new \Illuminate\View\ComponentAttributeBag())
                        ->class(['fi-sidebar-item-collapse-icon', 'ms-auto h-5 w-5 transition-transform duration-200'])
                        ->merge(['x-bind:class' => '{ "rotate-180": ! isOpen }']),
