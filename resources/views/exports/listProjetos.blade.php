<table style="border-collapse:collapse;width:100%;font-family:Arial, sans-serif;font-size:13px;">
    ...
    @foreach ($projetos as $projeto)
        <tr valign="middle" style="background:#ffffff; text-indent:10px;">
            ...
            <td valign="middle"
                style="border:1px solid #fff;word-wrap:break-word;white-space:normal;text-align:center">
            ...
            <td valign="middle"
                style="border:1px solid #fff;word-wrap:break-word;white-space:normal;text-align:center">
                {{ $projeto->cad_rea_inicio ? \Carbon\Carbon::parse($projeto->cad_rea_inicio)->format('d/m/Y') : '' }}
            </td>
            <td valign="middle"
                style="border:1px solid #fff;word-wrap:break-word;white-space:normal;text-align:center">
            ...
            <td valign="middle"
                style="border:1px solid #fff;word-wrap:break-word;white-space:normal;text-align:center">
                {{ $projeto->vis_rea_inicio ? \Carbon\Carbon::parse($projeto->vis_rea_inicio)->format('d/m/Y') : '' }}
            </td>
