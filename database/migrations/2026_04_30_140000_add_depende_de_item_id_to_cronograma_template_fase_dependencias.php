...
return new class extends Migration
{
    ...
    {
        Schema::table('cronograma_template_fase_dependencias', function (Blueprint $table) {
            ...
            $table->foreign('depende_de_item_id', 'ctfd_dep_item_fk')
                ->references('id')
    ...
    {
        Schema::table('cronograma_template_fase_dependencias', function (Blueprint $table) {
            $table->dropForeign('ctfd_dep_item_fk');
